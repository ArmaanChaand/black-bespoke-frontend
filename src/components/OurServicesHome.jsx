...
export default function OurServicesHome(){
    ...
    return (
        <>
        <section className="w-screen bg-theme-black px-8 sm:px-10 py-10 sm:pt-16 text-theme-white flex flex-col justify-center items-center gap-5">
            <LinedHeader>
                Our Services
            </LinedHeader>
            <ParaPrm
        ...
        <section className="mt-10 w-screen px-5 sm400:px-8 sm500:px-14 sm:px-0 py-10 sm:py-16 min-h-96 relative ">
            <ImageElm
            ...
            <div className="w-full sm:w-2/3 md:w-1/2 min-h-56 bg-theme-black/30 backdrop-blur-sm sm:ml-28 z-10 p-5 overflow-hidden rounded-sm">
